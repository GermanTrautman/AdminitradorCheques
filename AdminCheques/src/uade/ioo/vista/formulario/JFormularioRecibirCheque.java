...
public class JFormularioRecibirCheque 
	extends JFormularioBase
	implements IVistaAgregarChequeTercero{
	...
	public JFormularioRecibirCheque(AdministradorPagos modelo) {
		...
		this.btnAgregarCheque.addActionListener(
				new AgregarChequeTerceroController(this.getModelo(), this)
				);
